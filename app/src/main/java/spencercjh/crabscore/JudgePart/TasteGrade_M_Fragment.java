...
public class TasteGrade_M_Fragment extends Fragment {
    ...
    public TasteGrade_M_Fragment(UserOBJ userOBJ, TasteScoreOBJ tasteScoreOBJ) {
    ...
    private boolean updateInfo() {
        try {
            if (radio_enable1.isChecked()) {  //填写总分
                ...
                tasteScoreOBJ_M.setScore_fin(score_fin);
                ...
                tasteScoreOBJ_M.setScore_fin(score_ygys + score_sys + score_ghys + score_xwxw + score_gh + score_fbjr + score_bzjr);
                tasteScoreOBJ_M.setScore_ygys(score_ygys);
                tasteScoreOBJ_M.setScore_sys(score_sys);
                tasteScoreOBJ_M.setScore_ghys(score_ghys);
                tasteScoreOBJ_M.setScore_xwxw(score_xwxw);
                tasteScoreOBJ_M.setScore_gh(score_gh);
                tasteScoreOBJ_M.setScore_fbjr(score_fbjr);
                tasteScoreOBJ_M.setScore_bzjr(score_bzjr);
            }
            return true;

...
public class GenerateCrabQualityScore extends Thread {
    ...
    public GenerateCrabQualityScore(String url, int competition_id, int group_id, int crab_sex, String update_user) {

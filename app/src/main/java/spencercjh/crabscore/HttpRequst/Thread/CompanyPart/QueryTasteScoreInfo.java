...
public class QueryTasteScoreInfo extends Thread{
    ...
    public QueryTasteScoreInfo(String url, int group_id, int competition_id, int crab_sex) {
    ...
    private void doGet() throws IOException {
        ...
        try {
            ...
            if (jsonstr.equals("query taste score failed")) {
                setFlag(false);
            } else {
                setFlag(true);
            }
